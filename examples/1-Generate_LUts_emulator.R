...
inputsPRO = read.table('examples/LUTs/inputs_PROSAIL_emulator.csv', sep=',', header = T)
nSamples =500
...
write.table(LUT.sb,file=paste('examples/LUTs/Emulators/LUT_n',nSamples_topredict/1000,'k_PROSAIL_forPredicting_sb.csv',sep=''),sep=',',row.names = F)
