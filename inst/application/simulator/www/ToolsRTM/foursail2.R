...
if (lai < 0){
  ...
  if (length(f_Non_ConS) > 0){
    resNCS <- NonConservativeScattering(m[f_Non_ConS],lai2,att[f_Non_ConS],sigb[f_Non_ConS],
  ...
  if (length(f_ConS) > 0){
    resCS <- ConservativeScattering(m[f_ConS],lai2,att[f_ConS],sigb[f_ConS],
  ...
  rsod <- 0 * m
  if (length(f_Non_ConS) > 0){
    resNCS <- NonConservativeScattering(m[f_Non_ConS],lai1,att[f_Non_ConS],sigb[f_Non_ConS],
                                        ks,ko,sf[f_Non_ConS],sb[f_Non_ConS],vf[f_Non_ConS],vb[f_Non_ConS],tss,too)
    tdd[f_Non_ConS] <- resNCS$tdd
    rdd[f_Non_ConS] <- resNCS$rdd
    tsd[f_Non_ConS] <- resNCS$tsd
  ...
  if (length(f_ConS) > 0){
    resCS <- ConservativeScattering(m[f_ConS],lai1,att[f_ConS],sigb[f_ConS],
                                    ks,ko,sf[f_ConS],sb[f_ConS],vf[f_ConS],vb[f_ConS],tss,too)
    tdd[f_ConS] <- resCS$tdd
    rdd[f_ConS] <- resCS$rdd
    tsd[f_ConS] <- resCS$tsd
