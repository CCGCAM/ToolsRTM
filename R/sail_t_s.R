...
#' SAIL-PROSPECT-SOIL to compute crown transmittance for sun direction
#'
#' @param lai  LAI 
...
#' @examples
#' 
sail_t_s<-function(lai,LIDFa,hotspot,tts,skyl,rsoil,tto,psi,TypeLidf=2,refl,tran){
  # rosoil is undertorey
  rho	 <- refl
  tau	 <- 	tran
