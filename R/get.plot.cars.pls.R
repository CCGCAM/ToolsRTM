...
#'
#' This function generates a plot for the results of Competitive Adaptive Reweighted Sampling (CARS) for partial least squares (PLS) analysis.
#'
#' @param CARS An object returned by the \code{\link{get.cars.pls}} function.
#'
#' @return A plot representing the results of the CARSPLS analysis.
#' @export
#'
get.plot.cars.pls<-function(CARS){
...
#+++ Output 1
plot(Nvar,xlab="Number CARS-PLS iteration",ylab="n variables",
     pch=16,col="blue",cex.lab=1.6,cex.axis=1.5)
...
plot(Coef[1,],ylim=range(Coef),type="l",xlab="Number CARS-PLS iteration",
     ylab="coefficient path",col="blue",cex.lab=1.6,cex.axis=1.5)
